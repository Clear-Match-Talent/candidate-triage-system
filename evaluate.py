#!/usr/bin/env python3
"""
Quick candidate triage evaluation script using Claude API directly.
Usage: python evaluate.py <input.csv> <output.csv>
"""
...
def calculate_decision(location_result, experience_result, education_result):
    ...
    if 'NOT_MET' in statuses:
        ...
        if location_result['status'] == 'NOT_MET':
            ...
            dismiss_reason = 'experience_senior_plus'
        ...
        if experience_result['status'] == 'UNKNOWN':
            review_focus.append('experience_senior_plus')
